...
async def start(_, m: Message):
    if m.chat.type == ChatType.PRIVATE:
        ...
        await accha.edit("__ʀᴜᴋʜ ʙᴏsᴅᴋ ..__")
        await asyncio.sleep(0.2)
        await accha.edit("__ᴀʙᴇ ʀᴜᴋʜ ɴᴀ.....__")
        await asyncio.sleep(0.2)
        await accha.edit("__ʟᴇ ᴀʙ ɢᴀɴᴅ ᴍᴀʀᴀ ᴀᴘɴɪ ʙᴏsᴅᴋ..__")
        await asyncio.sleep(0.2)
        await accha.delete()
...
async def help(client: MickeyBot, m: Message):
    if m.chat.type == ChatType.PRIVATE:
        ...
        await m.reply_photo(
            photo=random.choice(IMG),
            caption="**ʜᴇʏ, ʜᴇʟᴘ ᴄᴏᴍᴍᴀɴᴅs ᴋᴇ ᴋɪʏᴇ ᴘᴍ ᴋʀ ᴀᴘɴɪ ʙᴀɴᴅɪ ᴋᴀ ɴᴜᴍʙᴇʀ !**",
